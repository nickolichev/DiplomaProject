...
//    @DisplayName("Сводный метод проверок видимости НЕзаполненных полей на экране Creating Claims + проверка счетчика поля Title")
...
// использовать valid Date
    ...
    @DisplayName("test-case #7 Сводный метод проверок ПОСЛЕ создания Claim в развернутой карточке Claim")
    ...
    @DisplayName("test-case #7 Сводный метод проверок в развернутой карточке Claim ПОСЛЕ создания Comment ")
...
//
    ...
    @DisplayName("test-case #8 / Сводный метод проверок ПОСЛЕ создания Claim в развернутой карточке Claim")
    ...
    @DisplayName("test-case #8 / Сводный метод проверок видимости значений полей на экране Editing Claims перед редактированием")
    public void checkAllFieldsAndButtonsViewEditingClaims_Visibility() {
        ...
        new CheckUtils_Claims().checkFilledInputFieldTitle_Visibility();  // поменять Title
//        new CheckUtils_Claims().checkCharactersEntered_Visibility();
        new CheckUtils_Claims().checkFieldExecutor_Visibility();
        new CheckUtils_Claims().checkIconFieldExecutor_Visibility();
...
//        new CheckUtils_Claims().checkFieldTime_Visibility();           // непонятно что с изменением Time
    ...
    @DisplayName("test-case #8 / Сводный метод проверок ПОСЛЕ РЕДАКТИРОВАНИЯ Claim в развернутой карточке Claim")
    ...
    @DisplayName("test-case #8 / Сводный метод проверок ПОСЛЕ перевода в статус In Progress в развернутой карточке Claim")
    ...
    @DisplayName("test-case #9 + #10 / экран CREATING CLAIM / Сводный метод создания Claim в статусе In Progress")
    public void creatingClaimInProgressStatusCustomExecutor() {
        new Utils_Claims().clickCreateClaim();
    ...
    @DisplayName("test-case #10 / Проверка в развернутой карточке Claim после поиска в списке Executed")
    ...
    @DisplayName("test-case #9 + #10 / Проверка в развернутой карточке Claim после поиска в списке In Progress")
