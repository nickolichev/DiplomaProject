...
public class NewsData {
    ...
    // для проверки в нераскрытых карточках и для создания новых
    ...
    public static final String DATE_CREATED = "15.11.2023";
    ...
    public static final String CATEGORY_FOR_ALL = "Category";
    ...
    public static final String DROPDOWN_CATEGORY = "Show dropdown menu";
    public static final String DATE_START = "DD.MM.YYYY";
    public static final String DATE_END = "DD.MM.YYYY";
    public static final String DATE_START_TEST_DATA = "14.09.2023"; // если валидная дата = 15.09.2023
    public static final String DATE_END_TEST_DATA = "16.09.2023";   // если валидная дата = 15.09.2023
    ...
    public static final String PUBLICATION_DATE_VALUE = "15.09.2023"; // эта дата устанавливается при создании NEWS
    ...
    // набор тестовых данных DESCRIPTION в Control panel для всех категорий
    ...
    // набор тестовых данных TITLE_EDITING для всех категорий
    // использовать в input для редактирования
    // использовать в check после редактирования
    ...
    // набор тестовых данных DESCRIPTION_EDITING для всех категорий
    // использовать в input для редактирования
    // использовать в check после редактирования
    // попробовать написать метод добавления к тексту = "Редактирование", а не полной замены текста
